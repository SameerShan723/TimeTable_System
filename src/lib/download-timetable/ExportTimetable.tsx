  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="bg-[#042954] py-3 md:py-2 px-14 w-full cursor-pointer text-white hover:brightness-110  transition-colors rounded-md flex items-center justify-center gap-2 disabled:opacity-50 text-sm md:text-lg"
